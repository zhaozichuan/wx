...
var login = function login(options) {
  ...
  var doLogin = () => getWxLoginResult_new(function (wxLoginError, wxLoginResult) {
    if (wxLoginError) {
...
var getWxLoginResult_new = function (callback) {
  ...
  userResult.encryptedData = wx.getStorageSync('encryptedData');
  userResult.code = wx.getStorageSync('code');
  userResult.iv = wx.getStorageSync('iv');
  userResult.userInfo = wx.getStorageSync('userInfo');
